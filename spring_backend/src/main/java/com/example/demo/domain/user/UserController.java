...
public class UserController {
  ...
  @GetMapping("/{id}")
  @PreAuthorize("hasAuthority('USER_READ') || @userPermissionEvaluator.isThemselfEvaluator(authentication.principal.user,#id)")
  ...
  @PutMapping("/{id}")
  @PreAuthorize("@userPermissionEvaluator.isThemselfEvaluator(authentication.principal.user,#id)")
  ...
  @DeleteMapping("/{id}")
  @PreAuthorize("hasAuthority('USER_DEACTIVATE') || @userPermissionEvaluator.isThemselfEvaluator(authentication.principal.user,#id)")
